...
train_data_gen = datagen.flow_from_directory(directory='C:\\Users\\ASUS\PycharmProjects\\Brain_Tumor_Prediction\\Training\\',
                                             target_size=(img_width, img_height),
                                             class_mode='categorical')
vali_data_gen = test_datagen.flow_from_directory(directory='C:\\Users\\ASUS\PycharmProjects\\Brain_Tumor_Prediction\\Testing\\',
                                            target_size=(img_width, img_height),
                                            class_mode='categorical')
